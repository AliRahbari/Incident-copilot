...
COPY incident-copilot-spring-boot-starter/pom.xml incident-copilot-spring-boot-starter/pom.xml
...
COPY incident-copilot-spring-boot-starter/src incident-copilot-spring-boot-starter/src
